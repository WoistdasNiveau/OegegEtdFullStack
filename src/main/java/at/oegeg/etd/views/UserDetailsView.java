...
public class UserDetailsView extends VerticalLayout implements HasUrlParameter<String>
{
    ...
    Button sendEmailAgainButton = new Button("Resend email");
    ...
    // == constructor ==
    public UserDetailsView(UserService _userService, VehicleService _vehicleService, WorkService _workService)
    {
    ...
    private void SetContent()
    {
        ...
        VerticalLayout finalView = new VerticalLayout(userTilte, userGrid, createdWorksView, updatedWorksView, createdVehiclesView, updatedVehiclesView);
    ...
    private void ConfigureGrids()
    {
        ...
        responsibleForGrid.addColumn(WorkDisplay::getResponsiblePerson).setHeader("Responsible Person").setSortable(true).setTextAlign(ColumnTextAlign.CENTER)
        ...
        createdVehiclesGrid.getColumns().forEach(col -> col.setAutoWidth(true));
        ...
        updatedVehiclesGrid.getColumns().forEach(col -> col.setAutoWidth(true));
    }

    private void ConfigureResponsibleForGrid()
    {
        responsibleForGrid.addClassName("list-view");
        responsibleForGrid.addThemeVariants(GridVariant.LUMO_ROW_STRIPES);
    ...
    private void ConfigureCreatedWorksGrid()
    {
        createdWorksGrid.addClassName("list-view");
        createdWorksGrid.addThemeVariants(GridVariant.LUMO_ROW_STRIPES);
    ...
    private void ConfigureUpdatedWorksGrid()
    {
        updatedWorksGrid.addClassName("list-view");
        updatedWorksGrid.addThemeVariants(GridVariant.LUMO_ROW_STRIPES);
    ...
    private void ConfigureCreatedVehiclesGrid()
    {
        createdVehiclesGrid.addClassName("list-view");
        createdVehiclesGrid.setSizeFull();
        createdVehiclesGrid.addThemeVariants(GridVariant.LUMO_ROW_STRIPES);
    ...
    private void ConfigureUpdatedVehiclesGrid()
    {
        updatedVehiclesGrid.addClassName("list-view");
        updatedVehiclesGrid.setSizeFull();
        updatedVehiclesGrid.addThemeVariants(GridVariant.LUMO_ROW_STRIPES);
